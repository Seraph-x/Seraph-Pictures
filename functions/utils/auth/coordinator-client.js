...
const OPERATIONS = new Set([
  ...
  'storageProfileLedgerStage',
  'storageRefReserve',
  'storageRefCommitStart',
  'storageRefCommitFinish',
  'storageRefReleaseStart',
  'storageRefReleaseFinish',
  'storageRefTransferStart',
  'storageRefTransferFinish',
  'storageRefReconcile',
  'shareCreate',
  'shareRead',
  'shareConsume',
